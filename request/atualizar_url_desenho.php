...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($requestData['title']) && isset($requestData['newURL'])) {
        ...
        $jsonFilePath = '../list/desenho_list.json';
        ...
        // Itera sobre as categorias e desenhos para encontrar o desenhos com o título correspondente
            ...
            foreach ($category as &$anime) {
                if ($anime['title'] === $requestData['title']) {
                    ...
                    if (!empty($requestData['newImage'])) {
                        // Atualiza a URL da imagem do desenho
                        $anime['image'] = $requestData['newImage'];
                    }

                    // Atualiza a URL do desenho
