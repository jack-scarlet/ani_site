...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($requestData['title']) && isset($requestData['newURL'])) {
        ...
        $jsonFilePath = '../list/anime_list.json';
        ...
        // Itera sobre as categorias e animes para encontrar o anime com o título correspondente
            ...
            foreach ($category as &$anime) {
                if ($anime['title'] === $requestData['title']) {
                    ...
                    if (!empty($requestData['newImage'])) {
                        // Atualiza a URL da imagem do anime
                        $anime['image'] = $requestData['newImage'];
                    }

                    // Atualiza a URL do anime
